...
function HeroArt() {
  return (
    <div className="relative mt-4 flex h-56 w-full max-w-xs items-center justify-center">
      ...
      <div className="gs-float-slow relative flex h-44 w-44 items-center justify-center">
        <span className="absolute inset-0 rounded-[2.5rem] bg-primary/20 blur-2xl" />
        <AppLogo className="gs-pop relative h-44 w-44 gs-delay-150" />
      </div>
    </div>
  );
}
    ...
    <div className="flex min-h-[100dvh] justify-center bg-secondary/60">
      <main className="relative flex h-[100dvh] w-full max-w-md flex-col overflow-hidden bg-background shadow-xl shadow-primary/5">
        <section className="pt-safe relative flex flex-1 flex-col items-center justify-center overflow-hidden bg-gradient-to-b from-accent/25 via-primary/10 to-background px-6">
          <div className="pointer-events-none absolute -left-16 top-10 h-52 w-52 rounded-full bg-primary/15 blur-3xl gs-blob" />
          <div className="pointer-events-none absolute -right-12 top-32 h-44 w-44 rounded-full bg-accent/25 blur-3xl gs-blob gs-delay-400" />

          <div className="gs-rise relative mt-6 text-center">
            <p className="text-[11px] font-semibold uppercase tracking-[0.55em] text-primary">
              Quickly
            </p>
            <h1 className="mt-1 font-display text-4xl font-bold text-foreground">Fast Delivery</h1>
          </div>

          <HeroArt />
        </section>

        <section className="pb-safe gs-slide-up relative -mt-8 rounded-t-[2rem] bg-card px-6 pt-8 shadow-[0_-12px_40px_-24px_oklch(0.64_0.19_36_/_0.5)]">
          <span className="mx-auto mb-6 block h-1.5 w-12 rounded-full bg-border" />
          <h2 className="gs-rise text-center font-display text-2xl font-bold leading-snug text-card-foreground gs-delay-100">
            Receive the world at
            <br />
            your doorstep
          </h2>
          <p className="gs-rise mx-auto mt-3 max-w-xs text-center text-sm text-muted-foreground gs-delay-150">
          ...
          <div className="mt-5 flex justify-center gap-4 text-[11px] font-medium text-muted-foreground">
            <span className="gs-rise inline-flex items-center gap-1.5 gs-delay-200">
              <BadgeCheck className="h-4 w-4 text-primary" /> Verified
            </span>
            <span className="gs-rise inline-flex items-center gap-1.5 gs-delay-300">
              <Truck className="h-4 w-4 text-primary" /> Live tracking
            </span>
            <span className="gs-rise inline-flex items-center gap-1.5 gs-delay-400">
          ...
          <Button
            asChild
            size="lg"
            className="tap-scale gs-glow mt-7 h-14 w-full rounded-2xl text-base gs-rise gs-delay-450"
          >
          ...
          <div className="gs-rise mt-4 flex items-center justify-between pb-4 text-sm gs-delay-500">
            <Link
              to="/auth"
