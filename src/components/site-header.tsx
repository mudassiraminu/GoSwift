...
const marketingLinks = [
  ...
  { to: "/for-providers" as const, label: "For providers" },
];
        ...
        <nav className="hidden items-center gap-1 md:flex">
          {marketingLinks.map((l) => (
            <Link
              ...
              to={l.to}
              className={cn(
                "rounded-xl px-3 py-2 text-sm font-medium text-muted-foreground transition-colors hover:bg-secondary hover:text-foreground",
